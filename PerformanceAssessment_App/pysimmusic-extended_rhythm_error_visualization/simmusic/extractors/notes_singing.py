...
def hpcp_extract(audio):
    ...
    for frame in ess.FrameGenerator(audio, frameSize=M, hopSize=H, startFromZero=True):          
...
def assess_singing(ref_audio_file, std_audio_file, ref_annotation_file):
    ...
    figure = visualize(ref_audio, std_audio, ref_pitch, std_pitch, ref_time_ticks, std_time_ticks_dtw)
